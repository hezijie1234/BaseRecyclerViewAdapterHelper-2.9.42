...
public class AnimationUseActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //RecyclerView 的Item宽或者高不会变,则设置此为true可以节省性能消耗
    ...
    private void initAdapter() {
        ...
        //第一次进入页面所有的第一页的item都会有动画，如果觉得效果不好可以设置(但是测试发现只有设置了isFirstOnly(true)之后才会有效果)
    ...
    private void initMenu() {
        ...
        mAnimationAdapter.isFirstOnly(false);//只有第一次进入才有动画
